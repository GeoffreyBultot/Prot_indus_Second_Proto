...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerSphereFogScript : WeatherMakerFogScript<WeatherMakerFogProfileScript>
    {
        ...
        protected override void LateUpdate()
        {
            ...
            pos.w = radius * radius;
            FogMaterial.SetVector(WMS._WeatherMakerFogSpherePosition, pos);
            FogMaterial.SetVector(WMS._WeatherMakerFogBoxCenter, pos);
            FogMaterial.SetVector(WMS._WeatherMakerFogVolumePower, new Vector4(1.0f / pos.w, FogProfile.FogEdgeSmoothFactor, FogProfile.FogHeightFalloffPower, FogProfile.FogEdgeFalloffPower));
