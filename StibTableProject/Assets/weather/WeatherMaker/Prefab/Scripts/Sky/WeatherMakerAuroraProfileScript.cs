...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerAuroraProfileScript : ScriptableObject
    {
        ...
        [Tooltip("Aurora shape scale, controls general aurora shape")]
        [Range(-10.0f, 10.0f)]
        public float ShapeScale = 1.42341f;

        [Tooltip("Aurora detail scale, controls finer details of the aurora")]
        [Range(-10.0f, 10.0f)]
        public float DetailScale = 2.9123f;
        ...
        [SingleLine("The min and max y values for the aurora")]
        public RangeOfFloats Height = new RangeOfFloats(10000.0f, 30000.0f);

        [Tooltip("Radius of planet to render aurora around")]
        ...
        public void UpdateShaderVariables()
        {
            ...
            Shader.SetGlobalFloat(WMS._WeatherMakerAuroraShapeScale, AnimationShapeScale);
            Shader.SetGlobalFloat(WMS._WeatherMakerAuroraDetailScale, AnimationDetailScale);
        ...
        public void AnimateFrom(WeatherMakerAuroraProfileScript oldProfile, float duration, string key, System.Action completion)
        {
            if (oldProfile != null)
            {
                TweenFactory.Tween(key, 0.0f, 1.0f, duration, TweenScaleFunctions.QuadraticEaseInOut, (ITween<float> v) =>
                {
                    ...
                    AnimationShapeScale = Mathf.Lerp(oldProfile.AnimationShapeScale, ShapeScale, v.CurrentProgress);
                    AnimationDetailScale = Mathf.Lerp(oldProfile.AnimationDetailScale, DetailScale, v.CurrentProgress);
        ...
        public void UpdateAnimationProperties()
        {
            ...
            AnimationShapeScale = ShapeScale;
            AnimationDetailScale = DetailScale;
        ...
        public float AnimationShapeScale { get; set; }
        public float AnimationDetailScale { get; set; }
