...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerSkyProfileScript : ScriptableObject
    {
            ...
            float skyAtmosphereTurbidity, float skyExposure, Color skyTintColor, float skyOuterRadius, float skyInnerRadius, float skyCameraHeight, Vector4 waveLength)
        {
            ...
            waveLength *= 1E-6f;
            Shader.SetGlobalVector(WMS._WeatherMakerSkyTotalRayleigh, GetTotalRayleigh(waveLength, skyRayleighMultiplier * skyAtmosphereThickness));
            Shader.SetGlobalVector(WMS._WeatherMakerSkyTotalMie, GetTotalMie(waveLength, skyAtmosphereTurbidity, skyMieMultiplier));
        }
