...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerShadowMapScript : MonoBehaviour
    {
        ...
        {
            if (Application.isPlaying && _light != null && commandBuffer != null)
            {
        ...
        {
            if (Application.isPlaying && _light != null && _commandBufferDepthShadows == null && !string.IsNullOrEmpty(ShaderTextureName))
            {
        ...
        {
            if (Application.isPlaying && CloudShadowMaterial != null && _light != null && _light.type == LightType.Directional &&
        ...
        private void LateUpdate()
        {
            ...
            if (Application.isPlaying && CloudShadowMaterial != null)
            {
                ...
                Shader.SetGlobalFloat(WMS._CloudShadowScale, CloudShadowMaterial.GetFloat(WMS._CloudShadowScale));
            }
        }
