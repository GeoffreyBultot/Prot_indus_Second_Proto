...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerProfileGroupScript : WeatherMakerBaseScriptableObjectScript, IComparer<WeatherMakerProfileAndWeight>
    {
        ...
        [MinMaxSlider(0.0f, 600.0f, "Override random duration for profiles to transition in, set to 0 to use the weather zone transition duration.")]
        public RangeOfFloats TransitionDuration = new RangeOfFloats { Minimum = 0, Maximum = 0 };

        [MinMaxSlider(0.0f, 600.0f, "Override random duration for profiles to hold before transition to another profile, set to 0 to use the weather zone hold duration.")]
        public RangeOfFloats HoldDuration = new RangeOfFloats { Minimum = 0, Maximum = 0 };
