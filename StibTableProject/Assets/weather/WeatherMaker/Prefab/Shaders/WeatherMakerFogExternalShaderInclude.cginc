...
uniform float _WeatherMakerFogFactorMax = 1.0;

uniform fixed _WeatherMakerFogDensity = 0.0;
uniform fixed _WeatherMakerFogFactorMultiplier = 1.0;
uniform fixed _WeatherMakerFogDensityScatter = 1.0;
