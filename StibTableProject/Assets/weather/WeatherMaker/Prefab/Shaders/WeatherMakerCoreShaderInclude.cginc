...
UNITY_DECLARE_SCREENSPACE_TEXTURE(_MainTex2);
...
#define WM_SAMPLE_DEPTH_TEXTURE_01(tex, uv) Linear01Depth(UNITY_SAMPLE_DEPTH(SAMPLE_DEPTH_TEXTURE(tex, uv)))
...
inline float WM_SAMPLE_DEPTH_DOWNSAMPLED_01(float2 uv)
{
	...
	{
	default:
		return Linear01Depth(UNITY_SAMPLE_DEPTH(SAMPLE_DEPTH_TEXTURE(_CameraDepthTexture, uv)));
