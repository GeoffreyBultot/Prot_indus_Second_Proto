...
// determine if point in sphere, return 1 if yes, 0 if no, spherePosition is x,y,z,radius squared
...
// determine if point is not in sphere, return 1 if yes, 0 if no, spherePosition is x,y,z,radius squared
